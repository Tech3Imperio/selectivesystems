          ...
          >
            <div className="flex items-center justify-center h-[17rem] w-full">
              <img
                ...
                title={item.title}
                alt={item.alt}
                className="h-[5.rem] w-[5rem] -py-1 md:h-[9.rem] md:w-[10rem] lg:h-[11.rem] lg:w-[11rem] xl:h-[7.rem] xl:w-[7rem] object-cover"
              />
            </div>
            <div className="p-2 flex-grow">
              ...
              <p className="mt-2 text-gray-600 text-sm md:text-base pt-5 pb-5">
                {item.desc}
              </p>
            </div>
          </div>
