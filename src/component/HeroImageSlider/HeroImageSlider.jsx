    ...
    <>
      ...
      >
        {aboutData.map((item, index) => (
          <div
            key={index}
            className=" h-[23rem] w-[11rem] pt-1 bg-white hover:border shadow hover:shadow-black rounded-3xl cursor-pointer overflow-hidden text-center flex flex-col items-center md:h-[28rem] md:w-[17rem] lg:h-[32rem] lg:w-[20rem] xl:h-[27rem] xl:w-[17rem]"
            // style={{
            //   height: "32rem",
          ...
          >
            <div className="flex items-center justify-center h-[17rem] w-full">
              <img
                ...
                title={item.title}
                alt={item.alt}
                className="h-[5.rem] w-[5rem] md:h-[9.rem] md:w-[10rem] lg:h-[11.rem] lg:w-[11rem] xl:h-[7.rem] xl:w-[7rem] object-cover"
              />
            </div>
