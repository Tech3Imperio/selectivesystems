          ...
          <div className="flex flex-col justify-center py-14 mb-4 md:py-0 relative z-10">
            <div className=" text-center md:text-left space-y-2 lg:max-w-[25rem]">
              ...
              <motion.p
                ...
                initial="hidden"
                animate="visible"
                className="text-gray-300 w-[16rem] ml-12  text-[0.500rem] font-raleway md:text-[0.860rem] md:w-[28rem] lg:ml-11 lg:w-[35rem] lg:text-sm xl:ml-36 xl:text-sm xl:w-[38rem] xl:py-2"
              >
